(function($) {
    ...
    $.fn.wPaint.extend({
        ...
        _drawTextUp: function(e) {
            var txtWidth = this.$textInput.width();
            var txtHeight = this.$textInput.height();

            if (txtWidth < 100) this.$textInput.css({ width: 100 });
            if (txtHeight < 20) this.$textInput.css({ height: 20 });
        },
