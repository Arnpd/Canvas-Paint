(function($) {
    ...
    Paint.prototype = {
        generate: function() {
            ...
            function createCanvas(name) {
                ...
                if (typeof FlashCanvas != "undefined") {
                    FlashCanvas.initElement(_this[canvasName]);
                }
                ...
                _this[ctxName].fillStyle = "white";
                _this[ctxName].fillRect(0, 0, _this[canvasName].width, _this[canvasName].height);
        ...
        _callShapeFunc: function(e) {
            ...
            if (canvasEvent === 'Down' && this.options.onShapeDown) { this.options.onShapeDown.apply(this, [e]); } else if (canvasEvent === 'Move' && this.options.onShapeMove) { this.options.onShapeMove.apply(this, [e]); } else if (canvasEvent === 'Up' && this.options.onShapeUp) { this.options.onShapeUp.apply(this, [e]); }
        },
        ...
        _drawShapeMove: function(e, factor) {
            ...
            this.ctxTemp.lineWidth = this.options.lineWidth;
        },
    ...
    Menu.prototype = {
        generate: function() {
            ...
            if (this.options.handle) { this.$menuHandle = this._createHandle(); } else { this.$menu.addClass('wPaint-menu-nohandle'); }
        ...
        _createIconBase: function(item) {
            ...
            if (item.title == "Pencil") {
                $iconImg = $('<div class="wPaint-menu-icon-img"><i class="fa fa-pencil" style = "font-size:18px;"></i></div>');
            } else if (item.title == "Undo") {
                $iconImg = $('<div class="wPaint-menu-icon-img"><i class="fa fa-undo" style = "font-size:18px;"></i></div>');
            } else if (item.title == "Redo") {
                $iconImg = $('<div class="wPaint-menu-icon-img"><i class="fa fa-repeat" style = "font-size:18px;"></i></div>');
            } else if (item.title == "Text") {
                $iconImg = $('<div class="wPaint-menu-icon-img" style="font-size:20px;">T</div>');
            } else if (item.title == "Save Image") {
                $iconImg = $('<div class="wPaint-menu-icon-img"><i class="fa fa-floppy-o" style = "font-size:18px;"></i></div>');
            } else if (item.title == "Load Image to Foreground") {
                $iconImg = $('<div class="wPaint-menu-icon-img"><i class="fa fa-download" style = "font-size:18px;"></i></div>');
            }
    ...
    $.fn.wPaint = function(options, value) {
        ...
        function runOpts() {
            ...
            if (wPaint) {
                if (wPaint[options]) { wPaint[options].apply(wPaint, [value]); } else if (value !== undefined) {
                    if (wPaint[func]) { wPaint[func].apply(wPaint, [value]); }
                    if (wPaint.options[options]) { wPaint.options[options] = value; }
                } else {
                    if (wPaint[func]) { values.push(wPaint[func].apply(wPaint, [value])); } else if (wPaint.options[options]) { values.push(wPaint.options[options]); } else { values.push(undefined); }
                }
            }
        }
